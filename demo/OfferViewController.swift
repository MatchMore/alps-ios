...
class OfferViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate  {
    ...
    func setupButtonsTopic(){
        ...
        for t in topicButtons{
            ...
            t.button.addTarget(self, action: #selector(OfferViewController.topicButtonTapped(button:)), for: .touchUpInside)
            i = i + 1
        }
    }
